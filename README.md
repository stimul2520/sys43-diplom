...
После каждого запроса по внешнему адресу балансировщика поочередно открывается вэб-страница Nginx, при этом по сути сервис идентичен.
